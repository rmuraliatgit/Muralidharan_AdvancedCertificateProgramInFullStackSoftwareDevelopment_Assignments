...
searchForm.addEventListener("submit", (e) => {
    ...
    const person = data.resume.find((item) => item.basics.name.toLowerCase() === searchTerm.toLowerCase());
    document.getElementById("content-container").style.display="block";
    if (person) {
        displayResume(person);
        displayHeader(person.basics.name, person.basics.AppliedFor);
    } else {
        alert("Person not found");
    }
});

function displayHeader(name, jobTitle) {
    header.innerHTML = `
    <h1>${name}</h1>
    <h3>Job applied for: ${jobTitle}</h3>
    <img id="usrImg" src="https://cdn-icons-png.flaticon.com/512/1077/1077114.png"></img>
  `;
...
// Left side
    leftDiv.appendChild(createSection("Personal Info", [
        "Email: " + resume.basics.email,
        "Phone: " + resume.basics.phone,
        "Location: " + resume.basics.location.city + ", " + resume.basics.location.state
    ]));

    leftDiv.appendChild(createSection("Technical Skills", resume.skills.keywords));
    leftDiv.appendChild(createSection("Hobbies", resume.interests.hobbies));

// Right side
    rightDiv.appendChild(createSection("Work Experience", [
        resume.work["Company Name"] + " - " + resume.work.Position,
        "From " + resume.work["Start Date"] + " to " + resume.work["End Date"],
        "Summary: " + resume.work.Summary
    ]));

    rightDiv.appendChild(createSection("Projects", [resume.projects.name + " - " + resume.projects.description]));
    rightDiv.appendChild(createSection("Education", [
        resume.education.UG.institute + " - " + resume.education.UG.course,
        "From " + resume.education.UG["Start Date"] + " to " + resume.education.UG["End Date"],
        "CGPA: " + resume.education.UG.cgpa
    ]));

    rightDiv.appendChild(createSection("Achievements", resume.achievements.Summary));

    resumeContainer.appendChild(leftDiv);
    resumeContainer.appendChild(rightDiv);
    document.body.appendChild(resumeContainer);

// Internship section
    rightDiv.appendChild(createSection("Internship", [
        resume.Internship["Company Name"] + " - " + resume.Internship.Position,
        "From " + resume.Internship["Start Date"] + " to " + resume.Internship["End Date"],
        "Summary: " + resume.Internship.Summary
    ]));

// Education - Senior Secondary and High School sections
    rightDiv.appendChild(createSection("Senior Secondary Education", [
        resume.education["Senior Secondary"].institute,
        "CGPA: " + resume.education["Senior Secondary"].cgpa
    ]));

    rightDiv.appendChild(createSection("High School Education", [
        resume.education["High School"].institute,
        "CGPA: " + resume.education["High School"].cgpa
    ]));}